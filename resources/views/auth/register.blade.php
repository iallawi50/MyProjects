                                ...
                                <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <form action="/profile" method="post" dir="ltr">
                                        ...
                                        <div class="form-check form-switch dropdown-item">
                                            <input class="form-check-input" name="darkmode" type="checkbox" id="darkmode" onchange="this.form.submit()">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="color: white" class="card-header text-center bg-primary">{{ __('إنشاء حساب جديد') }}</div>
